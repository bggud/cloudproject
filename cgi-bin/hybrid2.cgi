...
try:
	...
	for y in cursor.fetchall():
		...
		x = commands.getstatusoutput("sudo grep /etc/libvirt/qemu/Windows-"+y[1]+"-"+a+".xml -e autoport | awk '{print $3;}'| awk -F= '{print $2 ;}'" )
		c = x[1]
		d = c[1:-1]
		s =random.randint(2000,65535)
		f4 = int(s)
		f5 = str(f4)
		x = commands.getstatusoutput("sudo virsh start Windows-"+y[1]+"-"+a)
		print d
		print "hello1"
		print f5
		print "hello2"
